...
5. VALORES ESTIMADOS: calcule cada pedido a partir dos dados reais do caso (salário, período, jornada). É PROIBIDO lançar valores redondos genéricos e altos (ex.: R$ 15.000,00 "a apurar"). Quando não houver base de cálculo, use o marcador [VALOR A APURAR] em vez de um número inventado — inflar o valor da causa aumenta o risco de sucumbência do cliente.
