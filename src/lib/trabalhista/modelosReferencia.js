...
4. TÓPICOS DA CAUSA DE PEDIR (Usar Títulos em Negrito e Caixa Alta com marcadores '-'):
   ...
   - DO ARTIGO 71 DA CLT (Intervalo intrajornada suprimido — NATUREZA INDENIZATÓRIA PÓS-REFORMA: nos termos do art. 71, §4º, da CLT (Lei 13.467/2017), o pagamento do período suprimido tem natureza INDENIZATÓRIA. Peça APENAS o período suprimido + adicional convencional; NÃO peça reflexos em DSR, férias, 13º salário ou FGTS sobre esta verba especificamente — mencione expressamente a natureza indenizatória no texto e no rol de pedidos.)
   ...
   - DOS MINUTOS QUE ANTECEDEM E SUCEDEM A JORNADA DE TRABALHO (SOMENTE quando a entrevista relatar explicitamente que o reclamante precisava chegar antes e/ou ficar depois do horário oficial — ex.: preleção, troca de farda/equipamento, espera pela rendição. NÃO presuma 30min/30min como padrão da categoria; se a entrevista não mencionar isso, OMITA o tópico por completo. Se mencionar, use o tempo relatado, com adicional convencional e reflexos.)
   ...
   - DOS 10 (DEZ) MINUTOS DE DESCANSO, CONFORTO, HIGIENE E SEGURANÇA DO TRABALHO (Cláusula 33ª da CCT — SOMENTE quando a entrevista relatar que o reclamante trabalhava em pé/continuamente sem essas pausas, distinto da supressão do intervalo intrajornada do art. 71 CLT — são benefícios diferentes e cumulativos, mas AMBOS precisam de relato próprio. Se a entrevista só mencionar o intervalo intrajornada (art. 71), NÃO presuma que os 10 minutos também foram suprimidos — omita este tópico.)
   - DAS DIFERENÇAS DOS PAGAMENTOS DO ADICIONAL DE PERICULOSIDADE NAS HORAS EXTRAS (Súmula 132, I, TST — SOMENTE quando a entrevista indicar que o reclamante já recebe/recebia adicional de periculosidade, ou exerce função legalmente periculosa com essa remuneração devida — se não houver essa base, OMITA o tópico)
   ...
   - DA AUSÊNCIA DE CONCESSÃO DO VALE TRANSPORTE NAS FOLGAS TRABALHADAS (SOMENTE quando a entrevista indicar que o reclamante usa/usava transporte público/condução para ir ao trabalho — se a entrevista não mencionar vale-transporte ou meio de deslocação, OMITA este tópico por completo, mesmo havendo folgas trabalhadas)
   - DA AUSÊNCIA DE CONCESSÃO DO AUXÍLIO ALIMENTAÇÃO NAS FOLGAS TRABALHADAS (SOMENTE quando a entrevista indicar que o reclamante recebia/deveria receber vale-alimentação/refeição — se não houver menção alguma na entrevista, OMITA este tópico por completo, mesmo havendo folgas trabalhadas)
