      ...
      <div className="bg-white rounded-xl shadow-xl w-full max-w-md mx-4">
        <div className="flex items-center justify-between px-5 py-4 border-b border-[#dadce0]">
          <div className="flex items-center gap-2">
            ...
            <h2 className="font-semibold text-[#202124] text-sm">
              {selectedText ? 'Transformar seleção em variável' : 'Inserir variável'}
            </h2>
          </div>
        ...
        <div className="px-5 py-4">
          ...
          <p className="text-xs text-[#9aa0a6] mt-2">
            {selectedText
              ...
              : 'A variável será inserida no ponto onde está o cursor, sem alterar o layout ou a formatação.'}
          </p>
        </div>
